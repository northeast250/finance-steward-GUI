...
import { LS_LEFT_ICON_THRESHOLD } from "../../renderer/settings/control";
...
export const serializeLS = (ocrItems: OcrItems, width: number): TokenLS => {
  ...
  const data: TokenLS = initTokenLS();
  data.items = items;
