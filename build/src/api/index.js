...
exports.app.use("/docs", swagger_ui_express_1["default"].serve, function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../../build/swagger.json")); })];
